...
export const createMonhoc = ({ msmh, tenmh, sotinchi, mota, mshocky, sotiet, lythuyet, thuchanh, tuhoc }) =>
      ...
      try {
         ...
         if (monhoc) {
            ...
            const token =
               ...
               jwt.sign(
                  {
                     msmh: monhoc.destroy().msmh,
                     tenmh: monhoc.destroy().tenmh,
                  },
...
export const MonhocUpdate = ({ msmh, tenmh, sotinchi, mota, mshocky, sotiet, lythuyet, thuchanh, tuhoc }) =>
   new Promise(async (resolve, reject) => {
      try {
            ...
            await db.Monhoc.update(
               {
                  ...
                  lythuyet: lythuyet ? lythuyet : mh.lythuyet,
                  thuchanh: thuchanh ? thuchanh : mh.thuchanh,
                  tuhoc: tuhoc ? tuhoc : mh.tuhoc,
               },
               { where: { msmh } }
            )
