...
import { deleteLopByMslop, getListLop } from '../../store/actions/lop'
import { getListSinhvien } from '../../store/actions'
...
function Lop() {
   ...
   const handleRemoveLop = (lop) => {
      ...
      if (!kq) {
         dispatch(deleteLopByMslop(lop.mslop))
                     ...
                     <div className="tile-body">
                        <div className="row element-button">
                           <div className="col-sm-2">
                              <Link className="btn btn-add btn-sm" to={linkRoute.LOP_ADD} title="Thêm">
