	...
	return (
		<div className='fixed z-[1] pt-[100px] left-0 top-0 w-[100%] h-[100%] bg-[#0006]'>
			<div className='fixed z-[1] pt-[60px] left-0 top-0 w-[100%] h-[100%] bg-[#0006]'>
				<div className='absolute w-[450px] h-[550px] bg-white left-[50%] right-[50%] translate-x-[-50%] p-[10px] rounded-xl overflow-scroll'>
					...
					<div className='flex justify-between'>
						<div className='flex justify-center'>
							<div className='mx-2'>
								...
								<input
									onChange={(e) =>
										setDiem({ ...diem, giuaky: e.target.value })
									}
									id='gk'
									className='w-full border-[1px] border-solid rounded-sm w-[20%] p-[6px] focus:ring'
									type={"text"}
								...
								<input
									onChange={(e) =>
										setDiem({ ...diem, diemthi: e.target.value })
									}
									id='diemthi'
									className='w-full border-[1px] border-solid rounded-sm w-[20%] p-[6px] focus:ring'
									type={"text"}
