      ...
      <div>
         ...
         <aside className="app-sidebar">
            ...
            <ul className="app-menu">
               ...
               <li>
                  <Link className="app-menu__item" to={linkRoute.SINHVIEN_AD}>
               ...
               <li>
                  <Link className="app-menu__item" to={linkRoute.DS_NV}>
                     <i className="app-menu__icon bx bx-task" />
                     <span className="app-menu__label">DS đăng ký nguyện vọng</span>
                  </Link>
               </li>
               <li>
               ...
               <li>
                  <Link className="app-menu__item" to={linkRoute.HKHE_AD}>
                     <i className="app-menu__icon bx bx-task" />
                     <span className="app-menu__label">Quản lý lớp học hè</span>
                  </Link>
               </li>
            </ul>
         </aside>
